...
var _1=false;
function _2(e){
var _3=$.data(e.data.target,"__draggable").options;
var _4=e.data;
...
function _7(e){
var _8=$.data(e.data.target,"__draggable").options;
var _9=$.data(e.data.target,"__draggable").proxy;
if(_9){
_9.css("cursor",_8.cursor);
}else{
_9=$(e.data.target);
$.data(e.data.target,"__draggable").handle.css("cursor",_8.cursor);
}
_9.css({left:e.data.left,top:e.data.top});
};
function _a(e){
_1=true;
var _b=$.data(e.data.target,"__draggable").options;
...
$.data(e.data.target,"__draggable").droppables=_c;
var _e=$.data(e.data.target,"__draggable").proxy;
if(!_e){
if(_b.proxy){
if(_b.proxy=="clone"){
...
$.data(e.data.target,"__draggable").proxy=_e;
}else{
_e=$(e.data.target);
}
}
...
function _f(e){
_2(e);
if($.data(e.data.target,"__draggable").options.onDrag.call(e.data.target,e)!=false){
_7(e);
}
var _10=e.data.target;
$.data(e.data.target,"__draggable").droppables.each(function(){
var _11=$(this);
var p2=$(this).offset();
...
_1=false;
_2(e);
var _13=$.data(e.data.target,"__draggable").proxy;
var _14=$.data(e.data.target,"__draggable").options;
if(_14.revert){
if(_15()==true){
_16();
...
$.data(e.data.target,"__draggable").proxy=null;
};
function _15(){
var _17=false;
$.data(e.data.target,"__draggable").droppables.each(function(){
...
$.fn.__draggable=function(_19,_1a){
if(typeof _19=="string"){
return $.fn.__draggable.methods[_19](this,_1a);
}
return this.each(function(){
var _1b;
var _1c=$.data(this,"__draggable");
if(_1c){
_1c.handle.unbind(".__draggable");
_1b=$.extend(_1c.options,_19);
}else{
_1b=$.extend({},$.fn.__draggable.defaults,_19||{});
}
...
$.data(this,"__draggable",{options:_1b,handle:_1d});
_1d.unbind(".__draggable").bind("mousemove.__draggable",{target:this},function(e){
if(_1){
return;
}
var _1e=$.data(e.data.target,"__draggable").options;
if(_1f(e)){
$(this).css("cursor",_1e.cursor);
}else{
$(this).css("cursor","");
}
}).bind("mouseleave.__draggable",{target:this},function(e){
$(this).css("cursor","");
}).bind("mousedown.__draggable",{target:this},function(e){
if(_1f(e)==false){
return;
}
...
$.extend(e.data,_21);
var _22=$.data(e.data.target,"__draggable").options;
if(_22.onBeforeDrag.call(e.data.target,e)==false){
return;
}
$(document).bind("mousedown.__draggable",e.data,_a);
$(document).bind("mousemove.__draggable",e.data,_f);
$(document).bind("mouseup.__draggable",e.data,_12);
$("body").css("cursor",_22.cursor);
});
function _1f(e){
var _23=$.data(e.data.target,"__draggable");
var _24=_23.handle;
var _25=$(_24).offset();
...
$.fn.__draggable.methods={options:function(jq){
return $.data(jq[0],"__draggable").options;
},proxy:function(jq){
return $.data(jq[0],"__draggable").proxy;
},enable:function(jq){
...
$.fn.__draggable.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,onBeforeDrag:function(e){
...
_90.__draggable("disable");
_90.css("cursor","pointer");
};
function _91(_92){
var _93=$.data(_92,"tree").options;
var _94=$.data(_92,"tree").tree;
_94.find("div.tree-node").__draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_95){
...
$(_96).__draggable("proxy").removeClass("tree-dnd-no").addClass("tree-dnd-yes");
...
$(_99).__draggable("proxy").removeClass("tree-dnd-yes").addClass("tree-dnd-no");
$(this).removeClass("tree-node-append tree-node-top tree-node-bottom");
...
_1c5.window.__draggable({handle:">div.panel-header>div.panel-title",disabled:_1c5.options.__draggable==false,onStartDrag:function(e){
if(_1c5.mask){
...
return $.data(jq[0],"window")==null?null:$.data(jq[0],"window").window;
...
var t=$(_1ce);
return $.extend({},$.fn.panel.parseOptions(_1ce),{__draggable:(t.attr("__draggable")?t.attr("__draggable")=="true":undefined),resizable:(t.attr("resizable")?t.attr("resizable")=="true":undefined),shadow:(t.attr("shadow")?t.attr("shadow")=="true":undefined),modal:(t.attr("modal")?t.attr("modal")=="true":undefined),inline:(t.attr("inline")?t.attr("inline")=="true":undefined)});
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,__draggable:true,resizable:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _1cf(_1d0){
var t=$(_1d0);
...
win.window({title:opts.title,width:opts.width,height:opts.height,collapsible:false,minimizable:false,maximizable:false,shadow:false,__draggable:false,resizable:false,closed:true,onBeforeOpen:function(){
...
var rows=$.data(_3e0,"datagrid").data==null?null:$.data(_3e0,"datagrid").data.rows;
...
var rows = data == null? 0 : data.rows;
...
if(_451.length){
if(data!=null && _451.pagination("options").total!=data.total){
...
var rows=data==null?null:data.rows;
var _4ac=[];
if(rows!=null){
    for(var i=0;i<rows.length;i++){
...
var rows=$.data(_530,"datagrid").data==null?null:$.data(_530,"datagrid").data.rows;
...
if(data != null && typeof data.length=="number"&&typeof data.splice=="function"){
