...
{
    public class ChargerSampleFactory:SampleFactory
    {
        public ChargerSampleFactory(Guid userId) : base(userId) { }
        public override SamplePrivilige CreateSampePrivlige()
        {
            ...
            return new SampleChargerPrivilige();
        }

        public override SampleManager CreateSampleManager()
        {
            return new SampleChargeManager(__userId);
        }
    }
}
