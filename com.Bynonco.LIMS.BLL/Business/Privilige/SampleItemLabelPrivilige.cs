...
{
    public class SampleItemLabelPrivilige: PriviligeBase
    {
        public SampleItemLabelPrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "SampleItemLabel");
        }
        ...
        protected override void BuildPrivilige()
        {
            ...
            IsEnableGetGridViewSampleItemLabelList = GetIsEnableOpearteExtend(viewModuleFunctionList, "GetGridViewSampleItemLabelList");
        ...
        {
            return IsSuperAmin  || GetIsEnableOpearte(viewModuleFunctionList, actionName);
        }
        public bool IsEnableGetGridViewSampleItemLabelList { get; private set; }
