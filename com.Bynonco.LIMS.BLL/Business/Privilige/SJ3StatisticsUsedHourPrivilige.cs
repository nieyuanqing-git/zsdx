...
{
    public class SJ3StatisticsUsedHourPrivilige : PriviligeBase
    {
        public SJ3StatisticsUsedHourPrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "SJ3StatisticsUsedHour");
        }
