...
{
    public class AnimalFramePrivilige : PriviligeBase
    {
        public AnimalFramePrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "AnimalFrame");
        }
        protected override void BuildPrivilige()
        {
            var viewModuleFunctionList = GetUserWorkGroupModuleList();
            if (viewModuleFunctionList == null || viewModuleFunctionList.Count == 0) return;
            IsEnableGetGridViewAnimalFrameList = GetIsEnableOpearteExtend(viewModuleFunctionList, "GetGridViewAnimalFrameList");
        ...
        public bool IsEnableGetGridViewAnimalFrameList { get; private set; }
