...
{
    public class LabOrganizationPrivilige : PriviligeBase
    {
        public LabOrganizationPrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "LabOrganization");
        }
        protected override void BuildPrivilige()
        {
            ...
            IsEnableExamination = GetIsEnableOpearteExtend(viewModuleFunctionList, "ExaminationIndex");
        }
