...
{
    public class EquipmentOpenTrainingCarryOutPrivilige : PriviligeBase
    {
        public EquipmentOpenTrainingCarryOutPrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "EquipmentOpenTrainingCarryOut");
        }
