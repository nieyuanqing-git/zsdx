...
{
    public class TrainningQuestionPrivilige : PriviligeBase
    {
        public TrainningQuestionPrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "TrainningQuestion");
        }
        protected override void BuildPrivilige()
        {
            ...
            IsEnableView = GetIsEnableOpearteExtend(viewModuleFunctionList, "ViewQuestion");
