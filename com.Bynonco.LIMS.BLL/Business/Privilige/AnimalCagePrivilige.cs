...
{
    public class AnimalCagePrivilige : PriviligeBase
    {
        public AnimalCagePrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "AnimalCage");
        }
        protected override void BuildPrivilige()
        {
            var viewModuleFunctionList = GetUserWorkGroupModuleList();
            if (viewModuleFunctionList == null || viewModuleFunctionList.Count == 0) return;
            IsEnableGetGridViewAnimalCageList = GetIsEnableOpearteExtend(viewModuleFunctionList, "GetGridViewAnimalCageList");
        ...
        public bool IsEnableGetGridViewAnimalCageList { get; private set; }
