...
{
    public class ArticlePrivilige : PriviligeBase
    {
        public ArticlePrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "Article");
        }
        protected override void BuildPrivilige()
        {
            ...
            IsEnableEditShow = GetIsEnableOpearteExtend(viewModuleFunctionList, "EditShow");
        }
        ...
        public bool IsEnableEditShow { get; private set; }
    }
}
