...
{
    public class TrainningMaterialPrivilige : PriviligeBase
    {
        public TrainningMaterialPrivilige(Guid userId)
            : base(userId) { }
        protected override IList<ViewUserWorkGroupModuleFunction> GetUserWorkGroupModuleList()
        {
            return _viewUserWorkGroupModuleFunctionBLL.GetModuleFunctionListByWorkGroupIdsControllerName(_workGroupIdList, "TrainningMaterial");
        }
        protected override void BuildPrivilige()
        {
            ...
            IsEnableView = GetIsEnableOpearteExtend(viewModuleFunctionList, "ViewMaterial");
