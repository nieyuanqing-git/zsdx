...
{
    public class UserEquipmentContinuedAuthorizationBLL : BLLBase<UserEquipmentContinuedAuthorization>, IUserEquipmentContinuedAuthorizationBLL
    {
        private ISystemLogBLL __systemLogBLL;
        public UserEquipmentContinuedAuthorizationBLL()
        {
            __systemLogBLL = BLLFactory.CreateSystemLogBLL();
        }
        public void GenerateEntityLog(OperateType operateType, UserEquipmentContinuedAuthorization originalEntity, UserEquipmentContinuedAuthorization curEntity, string operateIP, ref XTransaction tran, bool isSupress)
        {
            string title="", content = "", contentHTML = "", entityName = "UserEquipmentContinuedAuthorization", entityCnName = "设备周期性授权";
        ...
        public void GenerateEntityLogData(OperateType operateType, UserEquipmentContinuedAuthorization originalEntity, UserEquipmentContinuedAuthorization curEntity,out string title, out string content, out string contentHTML, out string entityName, out string entityCnName)
        {
            entityName = "UserEquipmentContinuedAuthorization";
            entityCnName = "设备周期性授权";
            title = string.Format("{0}用户[{1}]仪器设备[{2}]周期性权限.",
